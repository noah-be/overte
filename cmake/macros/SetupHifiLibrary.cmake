...
macro(SETUP_HIFI_LIBRARY)
  ...
  foreach(SRC ${AVX_SRCS})
    ...
    elseif (NOT IOS AND (APPLE OR (UNIX AND (NOT ANDROID OR CMAKE_ANDROID_ARCH_ABI STREQUAL "x86_64"))))
  ...
  foreach(SRC ${AVX2_SRCS})
    ...
    elseif (NOT IOS AND (APPLE OR (UNIX AND (NOT ANDROID OR CMAKE_ANDROID_ARCH_ABI STREQUAL "x86_64") AND NOT CMAKE_SYSTEM_PROCESSOR STREQUAL "aarch64")))
  ...
  overte_find_qt(COMPONENTS ${${TARGET_NAME}_DEPENDENCY_QT_MODULES} QUIET REQUIRED CMAKE_FIND_ROOT_PATH_BOTH)
