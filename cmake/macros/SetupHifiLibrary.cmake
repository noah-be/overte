...
macro(SETUP_HIFI_LIBRARY)
  ...
  foreach(SRC ${AVX_SRCS})
    ...
    elseif (APPLE OR (UNIX AND (NOT ANDROID OR CMAKE_ANDROID_ARCH_ABI STREQUAL "x86_64")))
  ...
  foreach(SRC ${AVX2_SRCS})
    ...
    elseif (APPLE OR (UNIX AND (NOT ANDROID OR CMAKE_ANDROID_ARCH_ABI STREQUAL "x86_64") AND NOT CMAKE_SYSTEM_PROCESSOR STREQUAL "aarch64"))
