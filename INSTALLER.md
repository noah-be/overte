...
1. [Nullsoft Scriptable Install System](http://nsis.sourceforge.net/Download) - 3.12
  Install using defaults (will install to `C:\Program Files (x86)\NSIS`)
1. [NSIS Plugins](https://build-deps.overte.org/conan/nsis-overte-plugins/NSIS-plugins-1.1.zip)
  ...
  **Alternatively**, install the following:
      ...
      1. [nsProcess Plug-in for Nullsoft](http://nsis.sourceforge.net/NsProcess_plugin) - 1.6 (use the link marked **nsProcess_1_6.7z**)
          ...
          1. Copy `Plugins\nsProcessW.dll` to `C:\Program Files (x86)\NSIS\Plugins\x86-unicode\` and rename it to `nsProcess.dll`
