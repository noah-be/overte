...
public final class SafeDiagnostics {
    ...
    public enum Event {
        ...
        WORLD_STARTUP, WORLD_TUTORIAL_IMPORTED, WORLD_OTHER_IMPORTED, WORLD_IMPORT_FAILED, WORLD_PHYSICS_READY, WORLD_FRAME_SUBMITTED, WORLD_TUTORIAL_SELECTED, WORLD_REDIRECT_IMPORTED, WORLD_NAVIGATION_BLOCKED, WORLD_EMPTY_IMPORTED
    }
