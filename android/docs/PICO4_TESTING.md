...
android/tests/pico-device-free-test.sh --category openxr --category audio
android/tests/pico-device-free-test.sh --test webview-bridge
```
...
```bash
android/tests/pico-host-regression-test.sh --build-dir build-tests
```
