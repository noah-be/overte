...
javac -d "$build_dir" \
    "$repo_root/vr/pico/apps/picoInterface/src/main/java/org/overte/pico/PicoInterfaceActivityPolicy.java" \
    "$repo_root/vr/pico/apps/picoInterface/src/main/java/org/overte/pico/PicoActivityInstancePolicy.java" \
    "$repo_root/common/tests/java/org/overte/pico/PicoInterfaceActivityPolicyStandaloneTest.java"
java -cp "$build_dir" org.overte.pico.PicoInterfaceActivityPolicyStandaloneTest

activity="$repo_root/vr/pico/apps/picoInterface/src/main/java/org/overte/pico/PicoInterfaceActivity.java"
