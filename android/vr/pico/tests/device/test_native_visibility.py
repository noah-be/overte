...
class NativeVisibilityTest(unittest.TestCase):
    def test_real_java_jni_and_shared_qt_publication(self):
        ...
        auth_visibility = 'void DomainAccountManager::invalidatePendingAccessToken(' + auth_source.split(
            'void DomainAccountManager::invalidatePendingAccessToken(', 1)[1].split(
