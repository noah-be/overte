...
javac -d "$TEST_CLASSES" \
    "$REPO_ROOT/android/vr/pico/apps/picoInterface/src/main/java/org/overte/pico/PicoAudioBufferSize.java" \
    "$REPO_ROOT/android/vr/pico/apps/picoInterface/src/main/java/org/overte/pico/PicoAudioCaptureState.java" \
    "$REPO_ROOT/android/common/tests/java/org/overte/pico/PicoAudioCaptureStateTest.java" \
    "$REPO_ROOT/android/common/tests/java/org/overte/pico/PicoAudioBufferSizeTest.java"
