...
Pico 4 controller
  ...
  -> android/vr/pico/apps/picoInterface/openxr/OpenXrInputPlugin
...
free ordering contract is `python3 android/vr/pico/tests/pico-openxr-input-test.py`.
...
`node android/vr/pico/tests/pico-interaction-diagnostics-test.js`.
...
- [ ] Web-entity interaction is implemented and tracked separately in
  `android/vr/pico/docs/pico4-web-entities.md`. Keep the controller acceptance results
