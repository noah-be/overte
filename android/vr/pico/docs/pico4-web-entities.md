...
available for this Android target, and `android/common/cmake/pico-bootstrap.cmake`
...
Run `python3 android/vr/pico/tests/pico-webview-bridge-test.py` to verify transparent
frame readiness, JNI direct-buffer validation, Qt action translation,
background forwarding, and navigation cleanup. Run
`android/vr/pico/tests/pico-webview-input-test.sh` for the pure-Java Android gesture
