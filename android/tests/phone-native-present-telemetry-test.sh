...
require "$source_file" 'window_seconds=%\.2f present_fps=%\.2f new_frame_fps=%\.2f inter_present_p50_ms=%\.2f inter_present_p95_ms=%\.2f inter_present_max_ms=%\.2f texture_resource_mib=%\.2f texture_populated_mib=%\.2f texture_pending_transfer_mib=%\.2f' 'aggregate numeric metrics are incomplete'
