...
require "$tablet_source" 'setPosition\(0, 0\)' \
    'tablet is not anchored to the screen origin'
require "$tablet_source" 'setSize\(width, height\)' \
    'tablet does not follow the Android surface dimensions'
