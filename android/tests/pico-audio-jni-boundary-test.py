...
JAVA = (ROOT / "apps/picoInterface/src/main/java/org/overte/pico/AndroidAudioInput.java").read_text()
POLICY = (ROOT / "apps/picoInterface/src/main/java/org/overte/pico/AndroidAudioInputPolicy.java").read_text()
