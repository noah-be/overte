...
VALIDATOR = ANDROID_ROOT / "tests/phone-test-inventory-test.py"
INVENTORY = json.loads(
    (ANDROID_ROOT / "tests/phone-test-inventory.json").read_text(encoding="utf-8")
)
...
class PhoneInventoryAdversarialTest(unittest.TestCase):
    ...
    def _write_fixture(self):
        ...
        self._put("android/tests/suite/catalog.json", json.dumps(catalog))
    ...
    def _save_inventory(self):
        self._put("android/tests/phone-test-inventory.json", json.dumps(self.inventory))
    ...
    def test_new_phone_production_file_is_rejected(self):
        self._put(
            "android/apps/phoneInterface/src/main/java/org/overte/phone/UnownedPolicy.java",
            "class UnownedPolicy {}"
        )
    ...
    def test_unrelated_generic_file_is_not_accepted_as_evidence(self):
        ...
        generic = "android/tests/generic-test.txt"
