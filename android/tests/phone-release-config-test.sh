...
module_gradle="$android_dir/apps/phoneInterface/build.gradle"
root_gradle="$android_dir/build-phone.gradle"
manifest="$android_dir/apps/phoneInterface/src/main/AndroidManifest.xml"
