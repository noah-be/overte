...
readonly hifi_utils="$android_root/libraries/qt/src/main/java/io/highfidelity/utils/HifiUtils.java"
...
java -cp "$output" io.highfidelity.utils.AssetCacheExtractorStandaloneTest
