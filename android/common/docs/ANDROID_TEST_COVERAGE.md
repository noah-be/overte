...
`android/phone/tests/phone-test-inventory.json` is the CI-enforced ownership map behind this
...
`android/common/tests/project-module-inventory.json` separately prevents the other Android
