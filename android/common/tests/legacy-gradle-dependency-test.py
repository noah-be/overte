...
LEGACY_DIRECT_DEPENDENCY_INVENTORY = (
    ANDROID_ROOT / "common/tests/legacy-gradle-direct-dependencies.json")
GVR_EVIDENCE_SCRIPT = ANDROID_ROOT / "vr/quest/tests/legacy-gvr-evidence.py"
...
LEGACY_MODULES = {
    "framePlayer": "phone/apps/framePlayer/build.gradle",
    "interface": "phone/apps/interface/build.gradle",
    "oculus": "vr/quest/libraries/oculus/build.gradle",
    "picoInterface": "vr/pico/apps/picoInterface/build.gradle",
    "qt": "common/libraries/qt/build.gradle",
    "questFramePlayer": "vr/quest/apps/questFramePlayer/build.gradle",
    "questInterface": "vr/quest/apps/questInterface/build.gradle",
}
...
def legacy_toolchain_contract_errors(
    ...
    if "rootProject.name = 'overte-phone'" not in phone_settings or \
            "buildFileName = 'build.gradle'" not in phone_settings:
        errors.append("Phone no longer owns a separate root build")
    if "rootProject.name = 'overte-pico'" not in pico_settings or \
            "buildFileName = 'build.gradle'" not in pico_settings:
...
class LegacyGradleDependencyTest(unittest.TestCase):
    def test_legacy_native_modules_opt_into_the_isolated_cmake_boundary(self):
        ...
        for relative_path in (
                "phone/apps/interface/build.gradle",
                "vr/quest/apps/questInterface/build.gradle",
                "phone/apps/framePlayer/build.gradle",
                "vr/quest/apps/questFramePlayer/build.gradle"):
            source = (ANDROID_ROOT / relative_path).read_text(encoding="utf-8")
    ...
    def test_legacy_qt_module_accepts_conan_android_jars(self):
        source = (ANDROID_ROOT / "common/libraries/qt/build.gradle").read_text(
            encoding="utf-8")
        self.assertIn("System.getenv('HIFI_ANDROID_QT_ROOT')", source)
    ...
    def test_legacy_interface_owns_required_qt_resources(self):
        dependencies = (ANDROID_ROOT /
                        "phone/apps/interface/src/main/res/values/qt_dependencies.xml").read_text(
            encoding="utf-8")
        styles = (ANDROID_ROOT /
                  "phone/apps/interface/src/main/res/values/styles.xml").read_text(
            encoding="utf-8")
        ...
        domain_view = (ANDROID_ROOT /
                       "phone/apps/interface/src/main/res/layout/domain_view.xml").read_text(
            encoding="utf-8")
    ...
    def test_dedicated_legacy_wrapper_gates_toolchain_and_forwards_arguments(self):
        wrapper = ANDROID_ROOT / "common/legacy/gradlew"
    ...
    def test_legacy_build_config_strings_use_the_root_escaper(self):
        root_source = (ANDROID_ROOT / "common/legacy/build.gradle").read_text(encoding="utf-8")
    ...
    def test_legacy_version_code_policy_is_positive_and_bounded(self):
        source = (ANDROID_ROOT / "common/legacy/build.gradle").read_text(encoding="utf-8")
    ...
    def test_direct_dependency_inventory_has_honest_scope_and_module_set(self):
        inventory = json.loads(LEGACY_DIRECT_DEPENDENCY_INVENTORY.read_text(
            encoding="utf-8"))
        settings = (ANDROID_ROOT / "common/legacy/settings.gradle").read_text(encoding="utf-8")
    ...
    def test_legacy_gvr_dependency_chain_is_absent(self):
        ...
        for relative_path in ("common/legacy/build.gradle", "phone/apps/interface/build.gradle",
                              "phone/apps/interface/CMakeLists.txt"):
            source = (ANDROID_ROOT / relative_path).read_text(encoding="utf-8")
...
"""
    ...
    def test_legacy_toolchain_split_is_explicit_and_consistent(self):
        sources = [path.read_text(encoding="utf-8") for path in (
            ANDROID_ROOT / "common/legacy/settings.gradle",
            ANDROID_ROOT / "common/legacy/build.gradle",
            REPOSITORY_ROOT / "BUILD_ANDROID.md",
            ANDROID_ROOT / "common/gradle/wrapper/gradle-wrapper.properties",
            ANDROID_ROOT / "phone/settings.gradle",
            ANDROID_ROOT / "vr/pico/settings.gradle",
        )]
    ...
    def test_root_owns_legacy_plugin_and_repository_configuration(self):
        root = (ANDROID_ROOT / "common/legacy/build.gradle").read_text(encoding="utf-8")
    ...
    def test_interface_uses_root_build_authority_and_project_topology(self):
        interface = (ANDROID_ROOT / "phone/apps/interface/build.gradle").read_text(
            encoding="utf-8")
        settings = (ANDROID_ROOT / "common/legacy/settings.gradle").read_text(encoding="utf-8")
        ...
        self.assertIn("project(':interface').projectDir = new File(settingsDir, '../../phone/apps/interface')",
                      settings)
    ...
    def test_legacy_interface_has_no_exact_duplicate_dependencies(self):
        source = (ANDROID_ROOT / "phone/apps/interface/build.gradle").read_text(encoding="utf-8")
...
"""
    ...
    def test_legacy_toolchain_contract_rejects_version_and_topology_drift(self):
        valid = [
            ...
            "rootProject.name = 'overte-phone'\nbuildFileName = 'build.gradle'",
            "rootProject.name = 'overte-pico'\nbuildFileName = 'build.gradle'",
        ]
        ...
        for index, replacement in (
                ...
                (4, "rootProject.name = 'wrong-phone'\nbuildFileName = 'build.gradle'"),
                (5, "rootProject.name = 'wrong-pico'\nbuildFileName = 'build.gradle'")):
            broken = list(valid)
