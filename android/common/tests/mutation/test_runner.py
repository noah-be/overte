...
class MutationClassificationTest(unittest.TestCase):
    ...
    def test_baseline_failure_stops_before_mutants_and_writes_report(self):
        with tempfile.TemporaryDirectory() as temporary:
            ...
            summary_result = subprocess.run([
                sys.executable,
                str(runner.ROOT / "common/tests/reporting/generate_summary.py"),
    ...
    def test_curated_mutant_order_is_stable(self):
        ...
        self.assertEqual([
            ...
            "pending-attempt-while-paused", "touch-metrics-ime-threshold",
            "touch-metrics-ignore-density", "touch-metrics-drop-legacy-cutout-bottom",
            "asset-disable-containment",
            ...
            "login-submit-does-not-pend", "native-touch-invent-keyboard",
            "native-touch-disable-content-upper-bound",
