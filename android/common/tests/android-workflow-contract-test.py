...
class AndroidPhoneReleaseCandidateWorkflowContracts(unittest.TestCase):
    ...
    def test_mandatory_node_runtime_is_checked_before_host_tests(self):
        ...
        self.assertIn("android/phone/ci/check-phone-host-runtime.sh", self.source)
...
class AndroidPhoneEmulatorAcceptanceWorkflowContracts(unittest.TestCase):
    ...
    def test_unsigned_arm64_candidate_is_not_installed(self):
        ...
        self.assertIn("android/phone/phone-emulator-test.sh all", self.source)
    ...
    def test_emulator_reports_are_attempt_scoped(self):
        ...
        for report_path in (
            "android/phone/apps/phoneInterface/build/outputs/androidTest-results/connected/",
            "android/phone/apps/phoneInterface/build/reports/androidTests/connected/",
