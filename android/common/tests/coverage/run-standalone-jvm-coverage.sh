...
"$javac_command" -d "$classes_dir" \
    ...
    "$android_root/vr/pico/apps/picoInterface/src/main/java/org/overte/pico/PicoActivityInstancePolicy.java" \
...
"$java_command" -jar "$cli_jar" report "$execution_data" \
    ...
    --sourcefiles "$android_root/phone/apps/phoneInterface/src/main/java" \
    --sourcefiles "$android_root/phone/apps/interface/src/main/java" \
    --sourcefiles "$android_root/vr/pico/apps/picoInterface/src/main/java" \
    --sourcefiles "$android_root/common/libraries/qt/src/main/java" \
...
if [[ -n "$verify_command" ]]; then
    ...
    python3 "$android_root/common/tests/coverage/verify-jvm-coverage.py" \
