...
RUNNER = ANDROID_ROOT / "common/tests/quality/run-static-quality.sh"
INSTALLER = ANDROID_ROOT / "common/tests/quality/install-tools.sh"
...
''')
    ...
    def test_installer_and_workflow_pin_versions_and_digests(self):
        installer = (ANDROID_ROOT / "common/tests/quality/install-tools.sh").read_text(encoding="utf-8")
        requirements = (ANDROID_ROOT / "common/tests/quality/requirements.txt").read_text(encoding="utf-8")
