...
if grep -Fq 'tools.build:jobs=4' "$android_root/common/conan/profiles/phone-arm64-16k" \
        && grep -Fq 'tools.build:jobs=4' "$android_root/common/conan/profiles/phone-nonqt-arm64-16k"; then
