...
javac -d "$output" \
    ...
    "$android_root/phone/apps/interface/src/main/java/io/highfidelity/hifiinterface/LegacyAssetTextPolicy.java" \
    "$android_root/phone/apps/interface/src/main/java/io/highfidelity/hifiinterface/LegacyAdapterPositionPolicy.java" \
    "$android_root/phone/apps/interface/src/main/java/io/highfidelity/hifiinterface/LegacyDomainLocationPolicy.java" \
    "$android_root/phone/apps/interface/src/main/java/io/highfidelity/hifiinterface/LegacyUserPolicy.java" \
    "$android_root/phone/apps/interface/src/main/java/io/highfidelity/hifiinterface/LegacyCrashDumpPolicy.java" \
    "$android_root/phone/apps/interface/src/main/java/io/highfidelity/hifiinterface/LegacyCrashAnnotationPolicy.java" \
    "$android_root/phone/apps/interface/src/main/java/io/highfidelity/hifiinterface/LegacyOAuthRedirectPolicy.java" \
    "$android_root/phone/apps/interface/src/main/java/io/highfidelity/hifiinterface/LegacyOAuthStatePolicy.java" \
    "$android_root/phone/apps/interface/src/main/java/io/highfidelity/hifiinterface/provider/UserStoryDomainPolicy.java" \
    "$android_root/phone/apps/interface/src/main/java/io/highfidelity/hifiinterface/provider/LegacyLatestRequestGate.java" \
    "$android_root/phone/apps/interface/src/main/java/io/highfidelity/hifiinterface/provider/UserStoryRetrievalCoordinator.java" \
    "$android_root/phone/apps/interface/src/main/java/io/highfidelity/hifiinterface/task/LegacyProfilePagePolicy.java" \
    "$android_root/common/tests/java/io/highfidelity/hifiinterface/provider/UserStoryDomainPolicyStandaloneTest.java" \
    "$android_root/common/tests/java/io/highfidelity/hifiinterface/provider/LegacyLatestRequestGateStandaloneTest.java" \
    "$android_root/common/tests/java/io/highfidelity/hifiinterface/provider/UserStoryRetrievalCoordinatorStandaloneTest.java" \
    "$android_root/common/tests/java/io/highfidelity/hifiinterface/HifiUtilsStandaloneTest.java" \
    "$android_root/common/tests/java/io/highfidelity/hifiinterface/LegacyAssetTextPolicyStandaloneTest.java" \
    "$android_root/common/tests/java/io/highfidelity/hifiinterface/LegacyAdapterPositionPolicyStandaloneTest.java" \
    "$android_root/common/tests/java/io/highfidelity/hifiinterface/LegacyDomainLocationPolicyStandaloneTest.java" \
    "$android_root/common/tests/java/io/highfidelity/hifiinterface/LegacyUserPolicyStandaloneTest.java" \
    "$android_root/common/tests/java/io/highfidelity/hifiinterface/LegacyCrashDumpPolicyStandaloneTest.java" \
    "$android_root/common/tests/java/io/highfidelity/hifiinterface/LegacyCrashAnnotationPolicyStandaloneTest.java" \
    "$android_root/common/tests/java/io/highfidelity/hifiinterface/LegacyOAuthRedirectPolicyStandaloneTest.java" \
    "$android_root/common/tests/java/io/highfidelity/hifiinterface/LegacyOAuthStatePolicyStandaloneTest.java" \
    "$android_root/common/tests/java/io/highfidelity/hifiinterface/task/LegacyProfilePagePolicyStandaloneTest.java"
...
if grep -Eq 'Log\.[A-Za-z]+\([^;]*accessToken|accessToken[^;]*Log\.' \
        "$android_root/phone/apps/interface/src/main/java/io/highfidelity/hifiinterface/fragment/FriendsFragment.java"; then
    printf 'FAIL: legacy Friends UI must not log its access token\n' >&2
    exit 1
fi

main_activity="$android_root/phone/apps/interface/src/main/java/io/highfidelity/hifiinterface/MainActivity.java"
...
provider="$android_root/phone/apps/interface/src/main/java/io/highfidelity/hifiinterface/provider/UserStoryDomainProvider.java"
...
user_list_adapter="$android_root/phone/apps/interface/src/main/java/io/highfidelity/hifiinterface/view/UserListAdapter.java"
...
web_view_fragment="$android_root/phone/apps/interface/src/main/java/io/highfidelity/hifiinterface/fragment/WebViewFragment.java"
...
login_fragment="$android_root/phone/apps/interface/src/main/java/io/highfidelity/hifiinterface/fragment/LoginFragment.java"
...
profile_task="$android_root/phone/apps/interface/src/main/java/io/highfidelity/hifiinterface/task/DownloadProfileImageTask.java"
...
breakpad_service="$android_root/phone/apps/interface/src/main/java/io/highfidelity/hifiinterface/BreakpadUploaderService.java"
