...
```bash
python3 android/common/tests/android-workflow-contract-test.py
python3 android/phone/tests/phone-apk-provenance-test.py
python3 android/phone/tests/phone-release-version-test.py
python3 android/phone/tests/phone-release-metadata-test.py
```

Verify a locally built debug APK with the actual Android tools and package gate:

```bash
android/phone/ci/verify-phone-apk.py \
