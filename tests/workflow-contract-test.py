...
class MacOSWorkflowContracts(unittest.TestCase):
    ...
    def test_bootstrap_architecture_choice_is_native_and_cache_separated(self):
        ...
        self.assertIn("arm_runner_size:", self.source)
        self.assertIn("options: [standard, xlarge]", self.source)
        self.assertIn("inputs.arm_runner_size == 'xlarge' && 'macos-15-xlarge'", self.source)
        self.assertIn("inputs.target_arch == 'arm64' && 'macos-15'", self.source)
        self.assertIn("OVERTE_MACOS_BUILD_JOBS:", self.source)
        self.assertIn("inputs.arm_runner_size == 'standard' && '2'", self.source)
        self.assertIn("minimum_memory_bytes=6442450944", self.source)
...
"""
    ...
    def test_runtime_reuses_a_built_app_without_rebuilding(self):
        ...
        self.assertIn("timeout-minutes: 330", source)
