...
from contracts import validate_capabilities, validate_identifier
...
def main() -> int:
    ...
    if args.require_target and not targets:
        raise ValueError("adapter discovered no targets")
    if args.target:
