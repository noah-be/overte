...
class CallerTests(unittest.TestCase):
    ...
    def test_callback_queued_and_cleared_before_stop(self):
        self.assertRegex(self.source, r'refreshIOSAudioInput\(\);[\s\S]{0,100}Qt::QueuedConnection')
    ...
    def test_mute_closes_and_grant_reopens_actual_input(self):
        ...
        self.assertRegex(refresh, r'switchInputToAudioDevice\((?:device|defaultAudioDeviceForMode\()')
