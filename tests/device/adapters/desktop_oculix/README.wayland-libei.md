...
cd tests/device/adapters/desktop_oculix
...
```sh
OVERTE_DESKTOP_TARGETS=/private/targets/desktop.json \
  python3 adapter.py --platform linux authorize-input \
...
GNOME dialogs. Use `python3 -m unittest -v test_wayland_libei_client.py` for
