...
#define LAYOUT(X) layout(X)
    ...
    #define INTEGER_RESOURCE_BUFFER(SLOT, NAME) layout(binding=SLOT) uniform isamplerBuffer NAME
    ...
    #define INTEGER_RESOURCE_BUFFER(SLOT, NAME) uniform isamplerBuffer NAME
